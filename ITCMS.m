...
% Syntax:  ITCMS(epsilon,delta,M,s, plots,rh0,N,fc,omega,U00,h0,par,Nv,trunc)
%
...
if plots>0
    ...
    %                        Non-hydrostatic brtrp stream function
    %
    ...
    %                        Non-hydrostatic brtrp horizontal velocity                        
    %
    ...
    %                        Non-hydrostatic brtrp vertical velocity                        
    %
