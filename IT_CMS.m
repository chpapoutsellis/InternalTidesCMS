...
function [C] = IT_CMS(epsilon,delta,M,s,varargin)
...
%    subcritical ridge
%    IT_CMS(0.8, 0.5, 64, 6)
%    IT_CMS(0.8, 0.5, 64, 6,'plots',1) (with plots)
%    IT_CMS(0.8, 0.5, 64, 6,'plots',2) (with plots and video)
%    supercitical ridge
%    IT_CMS(1.2, 0.5, 128, 12)
%    IT_CMS(1.2, 0.5, 128, 12, 'plots',1) (with plots)
%    IT_CMS(1.2, 0.5, 128, 12, 'plots',2) (with plots and video)
%
